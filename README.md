...
## INSTALLATION SCRIPT
  ...
  ```html
  sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/RazVpn/v2/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh
...
systemctl restart wg-quick@wg0
  ...
  ```html
  wget https://raw.githubusercontent.com/RazVpn/v2/main/install/sstp.sh && chmod +x sstp.sh && screen -S sstp ./sstp.sh
 rm -f /root/sstp.sh
...
## Info :
 ...
 ## Script for RENT Only. Contact owner on Telegram @Ichikaa1 <a href="https://t.me/Ichikaa1" target=”_blank”><img src="https://img.shields.io/static/v1?style=for-the-badge&logo=Telegram&label=Telegram&message=Click%20Here&color=blue"></a>
...
[Owner](https://t.me/Ichikaa1)

[Channel RazVpn](https://t.me/RazVpnChannel)
...
<p align="center">
  <a><img src="https://img.shields.io/badge/Copyright%20©-Ichikaa%20AutoScriptVPN%202022.%20All%20rights%20reserved...-blueviolet.svg" style="max-width:200%;">
    </p>
   </p>
