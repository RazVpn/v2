...
#install cf
wget https://raw.githubusercontent.com/${GitUser}/v2/main/install/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/v2/main/install/ssr.sh && chmod +x ssr.sh && screen -S ssr ./ssr.sh
wget https://raw.githubusercontent.com/${GitUser}/v2/main/install/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
echo -e "\e[0;32mDONE INSTALLING SS & SSR\e[0m"
clear
#installwg
echo -e "\e[0;32mINSTALLING WIREGUARD...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/v2/main/install/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/v2/main/install/ohp.sh && chmod +x ohp.sh && ./ohp.sh
wget https://raw.githubusercontent.com/${GitUser}/v2/main/install/ohp-dropbear.sh && chmod +x ohp-dropbear.sh && ./ohp-dropbear.sh
wget https://raw.githubusercontent.com/${GitUser}/v2/main/install/ohp-ssh.sh && chmod +x ohp-ssh.sh && ./ohp-ssh.sh
