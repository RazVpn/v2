...
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   "  \e[$number [•1]\e[m \e[$below MENU XRAY VMESS & VLESS\e[m     \e[$number [•6]\e[m \e[$below MENU THEMES\e[m"
echo -e   "  \e[$number [•2]\e[m \e[$below MENU TROJAN XRAY & GO\e[m       \e[$number [•7]\e[m \e[$below CLEAR LOG VPS\e[m"
echo -e   "  \e[$number [•3]\e[m \e[$below MENU OPENSSH & OPENVPN\e[m      \e[$number [•8]\e[m \e[$below INFO ALL PORT\e[m"
echo -e   "  \e[$number [•4]\e[m \e[$below SYSTEM MENU\e[m                 \e[$number [•9]\e[m \e[$below CHANGE PORT\e[m"
echo -e   "  \e[$number [•5]\e[m \e[$below CHECK RUNNING\e[m               \e[$number [10]\e[m \e[$below REBOOT VPS\e[m"
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
