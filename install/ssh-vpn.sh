...
#OpenVPN
wget https://raw.githubusercontent.com/${GitUser}/v2/main/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -O add-ssh "https://raw.githubusercontent.com/${GitUser}/v2/main/add-user/add-ssh.sh"
wget -O trial "https://raw.githubusercontent.com/${GitUser}/v2/main/add-user/trial.sh"
wget -O del-ssh "https://raw.githubusercontent.com/${GitUser}/v2/main/delete-user/del-ssh.sh"
...
wget -O cek-ssh "https://raw.githubusercontent.com/${GitUser}/v2/main/cek-user/cek-ssh.sh"
...
wget -O renew-ssh "https://raw.githubusercontent.com/${GitUser}/v2/main/renew-user/renew-ssh.sh"
...
wget -O port-ovpn "https://raw.githubusercontent.com/${GitUser}/v2/main/change-port/port-ovpn.sh"
wget -O port-ssl "https://raw.githubusercontent.com/${GitUser}/v2/main/change-port/port-ssl.sh"
wget -O port-wg "https://raw.githubusercontent.com/${GitUser}/v2/main/change-port/port-wg.sh"
wget -O port-squid "https://raw.githubusercontent.com/${GitUser}/v2/main/change-port/port-squid.sh"
wget -O port-websocket "https://raw.githubusercontent.com/${GitUser}/v2/main/change-port/port-websocket.sh"
...
wget -O user-list "https://raw.githubusercontent.com/${GitUser}/v2/main/more-option/user-list.sh"
wget -O user-lock "https://raw.githubusercontent.com/${GitUser}/v2/main/more-option/user-lock.sh"
wget -O user-unlock "https://raw.githubusercontent.com/${GitUser}/v2/main/more-option/user-unlock.sh"
wget -O user-password "https://raw.githubusercontent.com/${GitUser}/v2/main/more-option/user-password.sh"
...
wget -O ssh "https://raw.githubusercontent.com/${GitUser}/v2/main/menu/ssh.sh"
...
wget -O port-ohp "https://raw.githubusercontent.com/${GitUser}/v2/main/change-port/port-ohp.sh"
